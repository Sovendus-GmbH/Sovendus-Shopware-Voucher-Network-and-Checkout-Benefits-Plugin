...
For more information, see https://radix-ui.com/primitives/docs/components/${titleWarningContext.docsSlug}`;
  ...
  function loadSettingsUi() {
    ...
    const fetchSettings = () => __async(this, null, function* () {
      var _a;
      console.log("[Sovendus React] Fetching settings");
      try {
        const url = ((_a = window.sovendusApi) == null ? void 0 : _a.getSettings) || "/api/v1/_action/sovendus/settings";
    ...
    const handleSettingsUpdate = (updatedSettings) => __async(this, null, function* () {
      ...
      try {
        const url = ((_a = window.sovendusApi) == null ? void 0 : _a.saveSettings) || "/api/v1/_action/sovendus/settings";
    ...
    function initializeUI(targetContainer) {
      return __async(this, null, function* () {
        console.log("[Sovendus React] Initializing UI");
        try {
          const currentSettings = yield fetchSettings();
